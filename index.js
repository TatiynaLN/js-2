...
*/
const obj = { name: 'Tatyana', surname: 'Kiselyova', age: 35, pets: true };
console.log(obj);
/*
    Задание 3:
...
let result = array[3] + array[7] +
    array[0] + array[8] + array[11] +
    array[5] + array[9] + array[6] +
    array[4] + array[1] + array[12] +
    array[2] + array[10];
console.log(result);
/*
    Задание 4:
...
*/
let oddNumbersStart = 21;
while (oddNumbersStart < 67) {
    console.log(oddNumbersStart);
    oddNumbersStart += 2;
}
/* это просто для практики сделала
let numbers = 21;
do {
    numbers += 2;
    console.log(numbers);
